...
export default defineComponent({
  ...
  data () {
    return {
      sideImg1: require('../assets/images/Group1.png'),
      sideImg2: require('../assets/images/Group2.png')
    }
  }
})
</script>
...
.hero-section {
  background-image: url('../assets/images/Group1.png'), url('../assets/images/Group2.png');
